...
imagen = tk.PhotoImage(file="/home/pi/Downloads/iconoBoost.png")
etiqueta_imagen = tk.Label(frame_izquierdo, image=imagen,borderwidth=0,bg=bg_color,activebackground=activebackground,highlightthickness=0, padx=10, pady=10, anchor="center")
etiqueta_imagen.pack(side=tk.TOP, padx=100, pady=50)

btn_ret = tk.Button(frame_izquierdo, text="CLOSE",borderwidth=0,bg=bg_color,highlightthickness=0,activebackground=activebackground,fg='white',font=('Roboto', 32,'bold'), command = ventana.destroy)
btn_ret.pack(side=tk.TOP)

btn_ret = tk.Button(frame_derecho, text="REBOOT",borderwidth=0,bg=bg_color,highlightthickness=0,activebackground=activebackground,fg='white',font=('Roboto', 32,'bold'), command = modify_config_file)
