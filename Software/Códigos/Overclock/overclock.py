...
with open("overclock.site") as file:
    file = file.readlines()
for line in file:
    x = line.strip()
...
btn_ret = tk.Button(root, text="<<", image = icon,borderwidth=0,bg=bg_color, highlightthickness=0,activebackground=activebackground, command = root.destroy)
